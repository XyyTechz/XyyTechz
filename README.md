...
- React, React Native, Tailwind CSS, Django, Bootstrap, ASP.NET, Axios 

### Databases
- MySQL (phpMyAdminn), PostgreSQL, MongoDB  

### Tools & Platforms
- Godot Engine, Firebase, VS Code, Github Desktop, Andriod Studio, Expo Go  
